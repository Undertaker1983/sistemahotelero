...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2021 a las 06:02:59
...
(13, 4, 16, '2021-04-29', '23:00:00', '2021-04-30', '20.00', 1, '10.00', 1, '23:00:00', 'Cancelado', 'Efectivo', 1);
...
(6, 6, 1, '101', 'CAMA 1 1/2 PLAZA', '20.00', 'Disponible', 1),
...
(16, 6, 1, '105', 'CAMA 1 1/2 PLAZA', '20.00', 'Disponible', 1),
(17, 6, 1, '102', 'prueba 123', '20.00', 'Disponible', 0),
(18, 7, 3, '206', 'Todos los servicios incluidos', '20.00', 'Disponible', 1),
...
(14, 1, 'Gaseosa', 46, '0.90', 5, '2021-04-18 17:11:52', 2, 1, 'img_producto.png');
...
--
ALTER TABLE `alojamiento`
  MODIFY `idalojamiento` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `consumo`
  MODIFY `idconsumo` int(100) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `consumo`
  ADD CONSTRAINT `consumo_ibfk_1` FOREIGN KEY (`idalojamiento`) REFERENCES `alojamiento` (`idalojamiento`),

<header>
	...
	<nav>
			<ul>
				...
				<li class="principal">
					<a href="index.php"><i class="fas fa-calendar-alt"></i> Reservas <span class="arrow"><i class="fas fa-angle-down"></i></span></a>
				...
				<li class="principal">
					...
					<ul>
						<li><a href="#"><i class="fas fa-plus"></i> Reporte Diario</a></li>

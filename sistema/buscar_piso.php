...
<body>
	...
	<section id="container">
		...
		<h1><i class="fas fa-hotel"></i> Pisos</h1>
		<a href="#" class="btn_new add_piso"><i class="fas fa-hotel"></i> Nuevo</a>
		
		<form action="buscar_piso.php" method="get" class="form_search">
	...
	<div class="containerTable">
		...
		<?php 
			...
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM pisos WHERE nombre_piso LIKE '%$busqueda%' 
																AND estado = 1  ");
			...
			$query = mysqli_query($conection,"SELECT idpiso, nombre_piso FROM pisos WHERE nombre_piso LIKE '%$busqueda%' AND estado = 1 
																ORDER BY idpiso ASC LIMIT $desde,$por_pagina 
				");
			...
			?>
				<tr class="row<?php echo $data["idpiso"]; ?>">
					...
					<td class="textcenter">
						...
						<a class="btn_editpersonas"  title="Editar" href="editar_piso.php?id=<?php echo $data['idpiso']; ?>"><i class="fas fa-edit"></i></a>

...
<table class="pie_pagina">
	<tr>
		<td><label class="label_encabezados">Técnico:</label> <p><?php echo $orden['nombre_tecnico']; ?></p></td>
		<td><label class="label_encabezados">Recibido por:</label></td>
		<td><label class="label_encabezados">Cliente:</label></td>
	</tr>
</table>
	...
	<div>
		<p class="nota">NOTA: Presente este documento para el retiro de su equipo, tiempo máximo para el retiro será de 48 horas después de haberle notificado su revisión y/o arreglo del mismo, caso contrario quedará en nuestras instalaciones con un valor de $1,50 por bodegaje diario.</p>

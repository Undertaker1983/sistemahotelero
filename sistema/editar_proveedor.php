					...
					<div class="tarjeta col-md-6 ">
							...
							<form action="" method="post">
								...
								<div class="tile-footer">
									<center><button type="submit" class="btn btn-primary" id="register">Actualizar Proveedor</button></center>
								</div>
							</form>
					...
					$('#register').click(function(e){
						...
						if(valid){
							...
							$.ajax({
								...
								data: {id: id, cedula: cedula, nombre: nombre,telefono: telefono,direccion: direccion,correo: correo, razon_social: razon_social, entidad_financiera: entidad_financiera, tipo_cuenta: tipo_cuenta, numero_cuenta: numero_cuenta},
